 ...
 * Generated at: 2019-06-11 05:15:59 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            });\r\n");
      out.write("        },\r\n");
      out.write("        onBeforeEdit:function(node){\r\n");
      out.write("        \toldMenuName=node.text;\r\n");
      out.write("        },\r\n");
      ...
      out.write("            \t\t\t});\r\n");
      out.write("        \t\t\t\t$.messager.alert('提示','创建'+node.text+' 分类成功!');\r\n");
      out.write("        \t\t\t}else{\r\n");
      out.write("        \t\t\t\t$.messager.alert('提示','创建'+node.text+' 分类失败!');\r\n");
      out.write("        \t\t\t\t_tree.tree(\"remove\",node.target);\r\n");
      out.write("        \t\t\t}\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\t$.post(\"/content/category/update\",{id:node.id,name:node.text},function(data){\r\n");
      out.write("        \t\t\tif(data.status == 200){\r\n");
      out.write("        \t\t\t\t$.messager.alert('提示','修改'+node.text+' 分类成功!');\r\n");
      out.write("        \t\t\t}else{\r\n");
      out.write("        \t\t\t\t$.messager.alert('提示','修改'+node.text+' 分类失败!');\r\n");
      out.write("        \t\t\t\t_tree.tree(\"update\",{\r\n");
      out.write("            \t\t\t\ttarget : node.target,\r\n");
      out.write("            \t\t\t\ttext:oldMenuName\r\n");
      out.write("            \t\t\t});\r\n");
      out.write("        \t\t\t}\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t}\r\n");
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.post(\"/content/category/delete/\",{parentId:node.parentId,id:node.id},function(data){\r\n");
      out.write("\t\t\t\t\tif(data.status==200){\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('提示','删除'+node.text+'分类成功!');\r\n");
      out.write("\t\t\t\t\t\ttree.tree(\"remove\",node.target);\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('提示','删除'+node.text+'分类失败!');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
