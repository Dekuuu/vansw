...
<body id="mainframe">
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/ego-logo.gif" alt="易购商城"></a>
		</div>
	</div>
...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<ul class="m">
				...
				<li class="fore2">返回<a href="/" target="_blank">易购首页</a></li>
	...
	<!-- footer start -->
	<jsp:include page="../commons/footer(1).jsp" />
	<!-- footer end -->
</body>
</html>